...
os.system("mysqldump --login-path=cronjob --single-transaction OldTimeHockey ApiUsageTelemetry DraftPicks Leagues Scoring Teams Teams_post Users > /var/www/OldTimeHockey/oth.sql")
