...
for row in values[1:]:
    ...
    if len(row) <= LEAGUE_ASSIGN_COL or row[LEAGUE_ASSIGN_COL] == "WAITLIST" or row[LEAGUE_ASSIGN_COL] == "NO RESPONSE": # or row[DIV_ASSIGN_COL] == "D1" or row[DIV_ASSIGN_COL] == "D3" or row[DIV_ASSIGN_COL] == "D4" or row[DIV_ASSIGN_COL] == "NEW":
        continue
